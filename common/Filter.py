...
def Filtering(ii, rawdata, numstds=4.5, minIzero=0.01, lin_filter=0.025, minTime=0.3, maxTime=12):
    ...
    IzeroMedian + numstds * IzeroSTD + linFit_unpump[1] - lin_filter
    ...
    return condFinalPump, condFinalUnPump, FilterParameters, IzeroFEL_pump, IzeroFEL_unpump, DataFluo_pump, DataFluo_unpump
