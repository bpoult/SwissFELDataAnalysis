...
def get_xes_pumped(filename, xasrawdata, DIR, DIRBS, roi, ynstamp, ii, numstds=4.5, minIzero=0.01, lin_filter=0.025, boot_choice = False, boot_number = 10):
    ...
    condPump, condUnPump, FilterParameters, Izero_pump, Izero_unpump = Filtering(ii, xasrawdata, numstds, minIzero, lin_filter)
    
    TFY_on = Izero_pump[condPump]
    TFY_off = Izero_unpump[condUnPump]
